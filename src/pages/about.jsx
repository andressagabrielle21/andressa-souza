  ...
  return (
    <PageContent>
        <div className="flex flex-col md:flex-row my-[3em] md:my-0 md:p-0 text-center md:text-left items-center justify-around min-h-[90vh] mx-[3rem]">
            ...
            <div className='md:max-w-[30%] animate-animateFromTop mb-[1.8rem] md:mb-0'>
                ...
                <p className='leading-[29px] mb-[2rem] text-[20px] font-semibold break-normal'>I’m a Full Stack Developer from Brazil, focused on the solution of problems and in the best experience for the users.</p>
            ...
            <div className="text-[16px] md:w-[28vw] animate-animateFromTop">
                ...
                <ul className='text-[20px] font-semibold leading-[1.8em] text-gray-'>
